...
/* SVR4 historically provided ioctls in different files. Some things like X11
 * actually handle really old OSes correctly, so we have to mirror this to
 * avoid a billion patches.
 */
#include <sys/filio.h> /* file ioctls */
